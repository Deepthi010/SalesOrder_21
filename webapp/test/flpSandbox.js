		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Sales Order",
									"targetURL": "#appsalesorderdisplay21-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"appsalesorderdisplay21-display": {
								"semanticObject": "appsalesorderdisplay21",
								"action": "display",
								"description": "SO for partner",
								"title": "Sales Order",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=app.salesorderdisplay21",
									"url": sap.ui.require.toUrl("app/salesorderdisplay21")
								}
							}
						}
					}
